...
if __name__ == "__main__":
    # angles to xyzrpy
    theta_angles=np.array([90,-100,180,0,90,0])
    theta=np.radians(theta_angles)
    print(f"度数:",theta_angles)
    print(f"弧度:",theta)


    #theta=[-pi/3,45*pi/180,30*pi/180,-130*pi/180,100*pi/180,-80*pi/180]
    Tn=forward_kinematics(theta)
    print("---Tn---")
    print(Tn)
    pose=matrixtopose(Tn)
    print("---pose---")
    print(pose)

    # xyzrpy to angles
    #T = posetomatrix(0.0547, 0.1362, 0.4606, 110.78 / 180 * pi, -20.92 / 180 * pi, 75.42 / 180 * pi)
    T = posetomatrix(pose[0], pose[1], pose[2], pose[3] / 180 * pi, pose[4] / 180 * pi, pose[5] / 180 * pi)
    print("---T---")
    print(T)
